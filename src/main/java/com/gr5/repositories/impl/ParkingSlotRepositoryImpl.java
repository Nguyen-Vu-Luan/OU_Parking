...
//
//    @Override
//    public List<ParkingSlots> getSlots(Map<String, String> params) {
//        Session s = this.factory.getObject().getCurrentSession();
//        CriteriaBuilder b = s.getCriteriaBuilder();
//        CriteriaQuery<ParkingSlots> query = b.createQuery(ParkingSlots.class);
//        Root root = query.from(ParkingSlots.class);
//        query.select(root);
//
//        if (params != null) {
